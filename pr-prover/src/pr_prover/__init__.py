...
gives it a synthetic home, and opens at most one narrow capability channel: push
to the bound branch and comment for the builder, comment and review for the
reviewers, nothing at all for a gate. No child holds a GitHub credential, so
merge, approval, deploy, and live-system authority are not things a child could
...
from .capabilities import CapabilityBroker, CapabilityScope
