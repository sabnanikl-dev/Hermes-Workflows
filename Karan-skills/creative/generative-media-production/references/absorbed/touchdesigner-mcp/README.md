...
The table above covers the 32 tools used in typical creative workflows. The remaining 4 tools (`td_project_quit`, `td_test_session`, `td_dev_log`, `td_clear_dev_log`) are admin/dev-mode utilities — see `references/absorbed/touchdesigner-mcp/references/mcp-tools.md` for the full 36-tool reference with complete parameter schemas.
...
See `references/absorbed/touchdesigner-mcp/references/network-patterns.md` for complete build scripts + shader code.
...
| File | What |
|------|------|
| `references/absorbed/touchdesigner-mcp/references/pitfalls.md` | Hard-won lessons from real sessions |
| `references/absorbed/touchdesigner-mcp/references/operators.md` | All operator families with params and use cases |
| `references/absorbed/touchdesigner-mcp/references/network-patterns.md` | Recipes: audio-reactive, generative, GLSL, instancing |
| `references/absorbed/touchdesigner-mcp/references/mcp-tools.md` | Full twozero MCP tool parameter schemas |
| `references/absorbed/touchdesigner-mcp/references/python-api.md` | TD Python: op(), scripting, extensions |
| `references/absorbed/touchdesigner-mcp/references/troubleshooting.md` | Connection diagnostics, debugging |
| `references/absorbed/touchdesigner-mcp/references/glsl.md` | GLSL uniforms, built-in functions, shader templates |
| `references/absorbed/touchdesigner-mcp/references/postfx.md` | Post-FX: bloom, CRT, chromatic aberration, feedback glow |
| `references/absorbed/touchdesigner-mcp/references/layout-compositor.md` | HUD layout patterns, panel grids, BSP-style layouts |
| `references/absorbed/touchdesigner-mcp/references/operator-tips.md` | Wireframe rendering, feedback TOP setup |
| `references/absorbed/touchdesigner-mcp/references/geometry-comp.md` | Geometry COMP: instancing, POP vs SOP, morphing |
| `references/absorbed/touchdesigner-mcp/references/audio-reactive.md` | Audio band extraction, beat detection, envelope following |
| `references/absorbed/touchdesigner-mcp/references/animation.md` | LFOs, timers, keyframes, easing, expression-driven motion |
| `references/absorbed/touchdesigner-mcp/references/midi-osc.md` | MIDI/OSC controllers, TouchOSC, multi-machine sync |
| `references/absorbed/touchdesigner-mcp/references/particles.md` | POPs and legacy particleSOP — emission, forces, collisions |
| `references/absorbed/touchdesigner-mcp/references/projection-mapping.md` | Multi-window output, corner pin, mesh warp, edge blending |
| `references/absorbed/touchdesigner-mcp/references/external-data.md` | HTTP, WebSocket, MQTT, Serial, TCP, webserverDAT |
| `references/absorbed/touchdesigner-mcp/references/panel-ui.md` | Custom params, panel COMPs, button/slider/field, panelExecuteDAT |
| `references/absorbed/touchdesigner-mcp/references/replicator.md` | replicatorCOMP — data-driven cloning, layouts, callbacks |
| `references/absorbed/touchdesigner-mcp/references/dat-scripting.md` | Execute DAT family — chop/dat/parameter/panel/op/executeDAT |
| `references/absorbed/touchdesigner-mcp/references/3d-scene.md` | Lighting rigs, shadows, IBL/cubemaps, multi-camera, PBR |
| `references/absorbed/touchdesigner-mcp/scripts/setup.sh` | Automated setup script |
