...
- `references/absorbed/pixel-art/scripts/pixel_art.py` — photo → pixel-art PNG (Floyd-Steinberg dithering)
- `references/absorbed/pixel-art/scripts/pixel_art_video.py` — pixel-art PNG → animated MP4 (+ optional GIF)
...
Named palettes live in `references/absorbed/pixel-art/scripts/palettes.py` (see `references/absorbed/pixel-art/references/palettes.md` for
