...
Full definitions: `references/absorbed/baoyu-infographic/references/layouts/<layout>.md`
...
Full definitions: `references/absorbed/baoyu-infographic/references/styles/<style>.md`
...
**Load references**: Read `references/absorbed/baoyu-infographic/references/analysis-framework.md` from this skill.
...
See `references/absorbed/baoyu-infographic/references/analysis-framework.md` for detailed format.
...
See `references/absorbed/baoyu-infographic/references/structured-content-template.md` for detailed format.
...
**Load references**: Read the selected layout from `references/absorbed/baoyu-infographic/references/layouts/<layout>.md` and style from `references/absorbed/baoyu-infographic/references/styles/<style>.md`.

Combine:
1. Layout definition from `references/absorbed/baoyu-infographic/references/layouts/<layout>.md`
2. Style definition from `references/absorbed/baoyu-infographic/references/styles/<style>.md`
3. Base template from `references/absorbed/baoyu-infographic/references/base-prompt.md`
...
- `references/absorbed/baoyu-infographic/references/analysis-framework.md` — Analysis methodology
- `references/absorbed/baoyu-infographic/references/structured-content-template.md` — Content format
- `references/absorbed/baoyu-infographic/references/base-prompt.md` — Prompt template
- `references/absorbed/baoyu-infographic/references/layouts/<layout>.md` — 21 layout definitions
- `references/absorbed/baoyu-infographic/references/styles/<style>.md` — 21 style definitions
