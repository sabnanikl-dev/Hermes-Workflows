...
Details: [references/absorbed/baoyu-comic/references/partial-workflows.md](references/absorbed/baoyu-comic/references/partial-workflows.md)

### Art, Tone & Preset Catalogue

- **Art styles** (6): `ligne-claire`, `manga`, `realistic`, `ink-brush`, `chalk`, `minimalist`. Full definitions at `references/absorbed/baoyu-comic/references/art-styles/<style>.md`.
- **Tones** (7): `neutral`, `warm`, `dramatic`, `romantic`, `energetic`, `vintage`, `action`. Full definitions at `references/absorbed/baoyu-comic/references/tones/<tone>.md`.
- **Presets** (5) with special rules beyond plain art+tone:
  ...
  Full rules at `references/absorbed/baoyu-comic/references/presets/<preset>.md` — load the file when a preset is picked.

- **Compatibility matrix** and **content-signal → preset** table live in [references/absorbed/baoyu-comic/references/auto-selection.md](references/absorbed/baoyu-comic/references/auto-selection.md). Read it before recommending combinations in Step 2.
...
Use the `clarify` tool to confirm options. Since `clarify` handles one question at a time, ask the most important question first and proceed sequentially. See [references/absorbed/baoyu-comic/references/workflow.md](references/absorbed/baoyu-comic/references/workflow.md) for the full Step 2 question set.
...
Full step-by-step workflow (analysis, storyboard, review gates, regeneration variants): [references/absorbed/baoyu-comic/references/workflow.md](references/absorbed/baoyu-comic/references/workflow.md).

## References

**Core Templates**:
- [analysis-framework.md](references/absorbed/baoyu-comic/references/analysis-framework.md) - Deep content analysis
- [character-template.md](references/absorbed/baoyu-comic/references/character-template.md) - Character definition format
- [storyboard-template.md](references/absorbed/baoyu-comic/references/storyboard-template.md) - Storyboard structure
- [ohmsha-guide.md](references/absorbed/baoyu-comic/references/ohmsha-guide.md) - Ohmsha manga specifics

**Style Definitions**:
- `references/absorbed/baoyu-comic/references/art-styles/` - Art styles (ligne-claire, manga, realistic, ink-brush, chalk, minimalist)
- `references/absorbed/baoyu-comic/references/tones/` - Tones (neutral, warm, dramatic, romantic, energetic, vintage, action)
- `references/absorbed/baoyu-comic/references/presets/` - Presets with special rules (ohmsha, wuxia, shoujo, concept-story, four-panel)
- `references/absorbed/baoyu-comic/references/layouts/` - Layouts (standard, cinematic, dense, splash, mixed, webtoon, four-panel)

**Workflow**:
- [workflow.md](references/absorbed/baoyu-comic/references/workflow.md) - Full workflow details
- [auto-selection.md](references/absorbed/baoyu-comic/references/auto-selection.md) - Content signal analysis
- [partial-workflows.md](references/absorbed/baoyu-comic/references/partial-workflows.md) - Partial workflow options
