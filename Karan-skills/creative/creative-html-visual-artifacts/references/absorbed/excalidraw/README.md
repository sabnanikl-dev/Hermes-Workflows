...
4. **Optionally upload** for a shareable link using `references/absorbed/excalidraw/scripts/upload.py` via `terminal`
...
Run the upload script (located in this skill's `references/absorbed/excalidraw/scripts/` directory) via terminal:
...
See `references/absorbed/excalidraw/references/colors.md` for full color tables. Quick reference:
...
- For dark mode diagrams, see `references/absorbed/excalidraw/references/dark-mode.md`
- For larger examples, see `references/absorbed/excalidraw/references/examples.md`
