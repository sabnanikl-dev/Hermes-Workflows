...
Historical xurl CLI notes have been absorbed under `references/absorbed/xurl/README.md`; use them only as legacy provider-specific reference when migrating old xurl workflows or command snippets.
