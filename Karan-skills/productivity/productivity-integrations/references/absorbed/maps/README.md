...
- If `distance`/`directions` fails with an SSL handshake error against OSRM, do not block the broader task; fall back to Google Maps/Travel search, city/route context, or another routing source and label the route-fit assumption.
