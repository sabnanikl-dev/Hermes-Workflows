...
5. If the command is also gateway-available, test it from at least one messaging platform (or run the gateway tests: `references/absorbed/debugging-hermes-tui-commands/scripts/run_tests.sh tests/gateway/`).
