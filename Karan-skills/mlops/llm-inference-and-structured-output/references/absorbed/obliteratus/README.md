...
See `skill_view(name="obliteratus", file_path="references/absorbed/obliteratus/references/analysis-modules.md")` for the full reference.
...
- `references/absorbed/obliteratus/templates/abliteration-config.yaml` — Standard single-model config
- `references/absorbed/obliteratus/templates/analysis-study.yaml` — Pre-abliteration analysis study
- `references/absorbed/obliteratus/templates/batch-abliteration.yaml` — Multi-model batch processing
